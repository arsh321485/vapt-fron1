          ...
          <div class="form-card">
            <div class="form-grid">
              ...
              <label v-if="showTeamSizeCount" class="field">
                <span class="label-text">
                  Exact Team Count <span class="req">*</span>
                </span>
                <input
                  class="webinar-input"
                  type="number"
  ...
  methods: {
    ...
    async submitForm() {
      ...
      if (!companyWebsite) {
        ...
        this.errors.company_website = "Enter a valid website URL.";
        hasError = true;
      }
      ...
      if (teamSize === "10+") {
        const parsed = Number(teamSizeCountRaw);
        if (
          teamSizeCountRaw === "" ||
          teamSizeCountRaw === null ||
          Number.isNaN(parsed) ||
          !Number.isInteger(parsed) ||
          parsed < 11
        ) {
          this.errors.team_size_count = "Enter an exact count of 11 or more.";
          hasError = true;
        } else {
      ...
      if (phone && !phoneRegex.test(phone)) {
        this.errors.phone_number = "Enter a valid phone number.";
        hasError = true;
      }
      ...
      if (teamSize === "10+" && teamSizeCount !== null) {
      ...
      try {
        ...
        // Map field-level API errors onto the form when present
