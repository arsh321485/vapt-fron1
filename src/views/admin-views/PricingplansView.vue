          ...
          <template v-else-if="step === 'details' && activePlan">
            <div class="pricing-flow mt-4 mt-md-5">
              ...
              <div class="pricing-detail-shell">
                ...
                <div v-else-if="needsReportUpload && !pendingAssetCount" class="pricing-alert pricing-alert--warn">
                ...
                <div class="pricing-checkout-main">
                  ...
                  <template v-else>
                    ...
                    <button
                      ...
                      :disabled="checkoutLoading || (activePlan.id === 'premium' && ((needsReportUpload && !pendingAssetCount) || estimate?.over_ceiling))"
...
export default {
  ...
  computed: {
    ...
    detailsContinueDisabled() {
      ...
      if (this.selectedPlan === 'premium' && this.needsReportUpload && !this.pendingAssetCount) return true;
      return false;
    },
    canContinueCustom() {
      return !!(
  ...
  methods: {
    ...
    async fetchEstimate() {
      ...
      try {
        ...
        if (/upload a report|no assets/i.test(message)) {
    ...
    async startFreemium() {
      ...
      try {
        ...
        await Swal.fire({
          ...
          text: data?.subscription?.trial_end
            ? `Trial is active until ${new Date(data.subscription.trial_end).toLocaleDateString()}.`
            : 'Your Freemium plan is now trialing.',
          confirmButtonColor: '#241447',
        });
        this.goAfterBilling();
      } catch (error) {
