          ...
          <div class="aur-limit-card">
            ...
            <p class="aur-limit-copy">
              <template v-if="planSuggestPrompt.unpaidResume">
                Your file is saved. Choose a plan and complete payment to continue.
                After payment you will add users, set risk criteria, then open the dashboard.
              </template>
              <template v-else>
...
export default {
  ...
  computed: {
    ...
    canContinueWithExistingFile() {
      if (this.planFitNotice) return false;
      ...
      try {
        ...
        if (await this.promptUnpaidPlanChoice('upload', this.existingReportIpCount)) {
          Swal.fire({
            ...
            text: 'Your file is saved. Pick the recommended plan or another plan, then complete payment.',
            confirmButtonColor: '#241447',
          });
          return;
        }
