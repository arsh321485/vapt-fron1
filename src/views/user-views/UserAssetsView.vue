                ...
                <div class="right-panel-header">
                  <div class="right-panel-header-row">
                    <div class="right-panel-header-main">
                      <h1 class="asset-detail-title mb-2">{{ selectedAsset?.asset }}</h1>
                        ...
                        <div class="vuln-accordion-header" role="button" @click="toggleAccordion(idx)">
                          ...
                          <div class="d-flex align-items-center gap-3 flex-shrink-0">
                            ...
                            <button
                              ...
                              @click.stop="openPythonGuide(vuln)"
                            >
...
class TLSConfigurator:
  ...
  computed: {
    ...
    toolboxVulnName() {
      ...
      const ip = this.selectedAsset?.asset;
    ...
    toolboxSeverity() {
      ...
      return asset ? this.getTopSeverity(asset.severity_counts) : 'Medium';
    },
    toolboxCve() {
