...
/**
 * Only a real expiry: HTTP 410, or expired/is_expired = true.
 * Do not treat valid:false, 404, or generic error text as expired.
 */
export function isExplicitInviteExpired(data: unknown, httpStatus?: number): boolean {
  ...
  return truthyFlag(payload.expired) || truthyFlag(payload.is_expired);
}
