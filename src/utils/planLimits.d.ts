...
export const FREEMIUM_MAX_UPLOAD_FILES: number;
...
export function setMagicLinkUnlimited(flag: unknown): void;
export function clearMagicLinkUnlimited(): void;
export function isMagicLinkUnlimited(): boolean;
export function hasFreemiumRestrictions(subscription: unknown): boolean;
...
export function isFreemiumReportUploadLimitMessage(text: unknown): boolean;
export function freemiumBlocksMultiFileUpload(opts?: {
  planId?: string;
  isFreemiumActive?: boolean;
  fileCount?: number;
}): boolean;
export function isFreemiumSingleFileRequiredMessage(textOrPayload: unknown): boolean;
export function freemiumMultiFileUserMessage(fileCount?: number): string;
export function classifyFreemiumUploadBlock(opts?: {
  planId?: string;
  isFreemiumActive?: boolean;
  fileCount?: number;
  message?: string;
  details?: unknown;
}): "multi_file" | "replace_slot" | "none";
export function uploadTransportErrorMessage(text: unknown): string;
...
export function parseFreemiumUpgrade(data: unknown): {
  eligible: true;
...
export function collectFreemiumTrimmedResults(data: unknown): unknown[];
export function formatFreemiumTrimmedMessage(row?: unknown): string;
export function rememberUploadedScanFiles(namesOrCount: unknown): number;
export function peekUploadedScanFileCount(): number;
export function peekUploadedScanFileNames(): string[];
export function clearUploadedScanFileMemory(): void;
