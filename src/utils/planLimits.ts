 ...
 * on the real amount from checkoutCustom()'s Stripe session. Custom is
 * Annual-only: $1.25/asset/month, billed as one annual charge of $15/asset
 * (matches the backend's checkout/custom/ pricing exactly).
 */
