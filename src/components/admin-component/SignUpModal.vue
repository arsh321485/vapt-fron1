...
import { readClaimInviteToken, setClaimInviteValid } from '@/utils/claimInvite';
  ...
  methods: {
    ...
    syncModalFromDeepLink() {
      const isAdminLink =
        ...
        isAdminSetPasswordDeepLink(this.$route?.query || {});
      ...
      if (isAdminLink) {
        ...
        this.formType = 'admin';
        this.showForm = true;
        this.adminActiveTab = hasAdminTokens ? 'setPassword' : 'signIn';
