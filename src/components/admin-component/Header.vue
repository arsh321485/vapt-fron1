...
export default {
  ...
  methods: {
    ...
    applyUserSetPasswordDeepLink() {
      ...
      // Magic link (?invite= / ?invite_token=) is HomeView Get Started — do not open User/Admin set-password.
      if (pick(q.invite) || pick(q.invite_token) || pick(q.inviteToken)) return;
