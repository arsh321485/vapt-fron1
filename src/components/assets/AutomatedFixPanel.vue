<template>
  <div class="auto-tab-content">
    ...
    <div v-if="showActions" class="rec-view-code-row">
      <button type="button" class="auto-btn-outline" @click="$emit('view-code')">
...
.cap-left { grid-column: 1; }
.cap-mid { grid-column: 2; }
.cap-bar-col { grid-column: 1 / -1; padding-top: 10px; }
